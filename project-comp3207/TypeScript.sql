...
--
-- Host: localhost    Database: TypeScript
-- ------------------------------------------------------
...
--
-- Table structure for table `RevokedToken`
--
...
--
-- Dumping data for table `RevokedToken`
--

LOCK TABLES `RevokedToken` WRITE;
/*!40000 ALTER TABLE `RevokedToken` DISABLE KEYS */;
/*!40000 ALTER TABLE `RevokedToken` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `story_list` WRITE;
/*!40000 ALTER TABLE `story_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `story_list` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-01-05 15:24:29
